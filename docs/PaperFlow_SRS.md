...
- **Customer Mobile Access**: Customers can use a React Native mobile app for iOS and Android to browse the catalog, purchase editions, read purchased content, and receive notifications.
...
| Customer (Web/Mobile) | Purchases, browses, and securely reads editions; downloads archives through the web portal or the React Native mobile app |
...
| **Customer (Web/Mobile)** | Account registration, catalog browsing, edition/archive purchase and reading via the web portal or React Native mobile app | Consumer catalog |
...
| FR-CM-004 | High | Support customer browsing, purchase, and content access through a React Native mobile app on iOS and Android. |
| FR-CM-005 | Medium | Deliver mobile push notifications for purchases, receipts, access updates, and account events. |
...
| NFR-USE-002 | Medium | Support the customer mobile experience on current iOS and Android versions with responsive layouts and stable offline-safe navigation for previously accessed content. |
...
**Limitations**
- PaperFlow is delivered through a web experience and a React Native customer mobile application for iOS and Android; native publisher/admin apps remain out of scope.
